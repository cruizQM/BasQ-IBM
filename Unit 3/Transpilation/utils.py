...
def circuit_characteristics(circuit):
    ...
    # Output the score and depth specifically for 2-qubit gates
    print(f'>> 2-qubit gate depth: {circuit.depth(lambda x: x.operation.num_qubits == 2)}')
    print(f'>> Score: {score_func(circuit)}')
